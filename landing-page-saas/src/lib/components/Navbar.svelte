<script lang="ts">
	import { Zap, Menu, X } from '@lucide/svelte';
...
>
	<nav class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
		<a href="#top" class="flex items-center gap-2 font-bold" onclick={() => (open = false)}>
		...
		<div class="flex items-center gap-2">
			<a href="#cennik" class="btn hidden preset-tonal md:inline-flex">Zaloguj się</a>
			<a href="#cennik" class="btn hidden preset-filled-primary-500 md:inline-flex">
				{product.cta}
			</a>
			<button
